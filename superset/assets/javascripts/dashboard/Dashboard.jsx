...
export function dashboardContainer(dashboard) {
    return Object.assign({}, dashboard, {
        ...
        adddrillDown(sliceId, col, vals) {
            ...
            if (this.DrillDowns[sliceId]["drillParams"].length != nextLevel) {
            ...
            this.store.dispatch(actions.UPDATE_DRILL(sliceId,this.readDrillDowns(sliceId)))
        },
        drill(sliceId, level) {
            if ((sliceId in this.DrillDowns)) {
        ...
        readDrillDowns(sliceId) {
            let val = []
            if (this.DrillDowns[sliceId]["drillParams"].length > 0) {
                val.push("home")
                this.DrillDowns[sliceId]["drillParams"].map(d => val.push(d.vals))
            }
            return val
        },
        readFilters() {
